    ...
    return (
      <View style={{ marginHorizontal: 17, marginTop: 10 }}>
        ...
        <View style={{ flexDirection: 'row', paddingTop: 20, paddingBottom: 14, backgroundColor: '#2F65BD', borderBottomLeftRadius: 5, borderBottomRightRadius: 5 }}>
          <GoPayFeatures onPress={()=> this.props.navigation.navigate('ScanQRCode')} img={require('../../../assets/icon/pay.png')} title={'Pay'} />
          <GoPayFeatures onPress={()=> this.props.navigation.navigate('')} img={require('../../../assets/icon/nearby.png')} title={'Nearby'} />
          <GoPayFeatures onPress={()=> this.props.navigation.navigate('')} img={require('../../../assets/icon/topup.png')} title={'TopUp'} />
          <GoPayFeatures onPress={()=> this.props.navigation.navigate('')} img={require('../../../assets/icon/more.png')} title={'More'} />
        </View>
      </View>
    )
  }
